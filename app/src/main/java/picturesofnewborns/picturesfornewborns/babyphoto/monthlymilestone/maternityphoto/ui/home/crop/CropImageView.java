...
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.animation.SimpleValueAnimator;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.animation.SimpleValueAnimatorListener;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.animation.ValueAnimatorV14;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.animation.ValueAnimatorV8;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.callback.Callback;
...
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.callback.LoadCallback;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.callback.SaveCallback;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.util.Logger;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.crop.util.Utils;
...
// Lifecycle methods ///////////////////////////////////////////////////////////////////////////
    ...
    private void drawHandles(Canvas canvas) {
        ...
        mPaintFrame.setStrokeWidth(dpTOpx(8f));
        canvas.drawLine(mFrameRect.left-dpTOpx(5f),mFrameRect.top-dpTOpx(2f),mFrameRect.left+dpTOpx(38f),mFrameRect.top-dpTOpx(2f),mPaintFrame);
        canvas.drawLine(mFrameRect.left-dpTOpx(2f),mFrameRect.top-dpTOpx(5f),mFrameRect.left-dpTOpx(2f),mFrameRect.top+dpTOpx(38f),mPaintFrame);
...
//        canvas.drawCircle(mFrameRect.right, mFrameRect.bottom, mHandleSize, mPaintFrame);
    ...
    public enum CropMode {
        FIT_IMAGE(0), RATIO_4_3(1), RATIO_3_4(2), SQUARE(3), RATIO_16_9(4), RATIO_9_16(5), FREE(
                6), CUSTOM(7), CIRCLE(8), CIRCLE_SQUARE(9), RATIO_2_3(10), RATIO_4_5(11);
