package picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.edit.sticker;
...
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.databinding.ItemStickerListBinding;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.databinding.ItemStickerListBinding;
import picturesofnewborns.picturesfornewborns.babyphoto.monthlymilestone.maternityphoto.ui.home.start.IconClickCallBack;

public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.IconViewHolder> {

    List<IconModel> iconModelList;
    Context context;
    IconClickCallBack iconClickCallBack;

    public StickerAdapter(Context context, List<IconModel> iconModelList, IconClickCallBack iconClickCallBack) {
    ...
    public IconViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemStickerListBinding itemIconModelBinding = ItemStickerListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
...
//            setCheck(iconModel);
    ...
    public static class IconViewHolder extends RecyclerView.ViewHolder {
        ItemStickerListBinding binding;

        public IconViewHolder(ItemStickerListBinding binding) {
