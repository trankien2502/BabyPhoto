...
public class TextSticker extends Sticker {
    ...
    private String typeface = "font/aeonik_pro_regular.otf";
    private boolean isUnderLine = false;
    private boolean isLineCentral = false;
    ...
    public TextSticker setColorText(int colorText) {
    ...
    public TextSticker setUnderLine(boolean underLine) {
    ...
    public boolean isLineCentral() {
        return isLineCentral;
    }

    public TextSticker setLineCentral(boolean lineCentral) {
    ...
    public TextSticker setItalic(boolean italic) {
        isItalic = italic;
